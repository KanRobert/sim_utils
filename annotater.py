...
if __name__ == '__main__':
    ...
    parser.add_argument('disasm', action='store', help='disasm file generated by [llvm-]objdump')
    parser.add_argument('profile', action='store', help='SDE profile data of JSON format')
